									...
									<ContextMenu key={index}>
										...
										<ContextMenuContent className="p-0 border-0">
											<ContextMenuItem 
												...
												className="cursor-pointer gap-3 pr-4 focus:bg-red-500 focus:text-slate-50"
												onClick={() => {handleRemovePlayer(`player-${player.playerName}`)}}
											>
									...
									<ContextMenu key={index}>
										...
										<ContextMenuContent className="p-0 border-0">
											<ContextMenuItem 
												disabled={(gameInfo.numPlayers + gameInfo.aiPlayers) <= 3}
												className="cursor-pointer gap-3 pr-4 focus:bg-red-500 focus:text-slate-50"
												onClick={() => {handleRemovePlayer("missingPlayer")}}
											>
								...
								<ContextMenu key={index}>
									...
									<ContextMenuContent className="p-0 border-0">
										<ContextMenuItem 
											disabled={(gameInfo.numPlayers + gameInfo.aiPlayers) <= 3}
											className="cursor-pointer gap-3 pr-4 focus:bg-red-500 focus:text-slate-50"
											onClick={() => {handleRemovePlayer("bot")}}
										>
			...
			<AlertDialog open={isAlertOpen} onOpenChange={setIsAlertOpen}>
                <AlertDialogContent className="gap-0">
					...
					<AlertDialogHeader className="space-y-0 mb-8">
						<AlertDialogTitle>Are you sure you want to remove {removePlayerName}?</AlertDialogTitle>
					...
					<AlertDialogFooter>
						...
						<AlertDialogCancel className="w-24 bg-slate-900 text-slate-50 hover:bg-slate-900/90 hover:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50/90">Cancel</AlertDialogCancel>
					</AlertDialogFooter>
				</AlertDialogContent>
			</AlertDialog>
